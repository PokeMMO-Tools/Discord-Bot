...
// Default to German language
const DEFAULT_LANGUAGE = 'de';
const DISPLAY_LANGUAGE = 'de';
...
const onExecute = async (interaction) => {
    ...
    const ITEMS = await getItems();
    const item = ITEMS.find(i => i["n"]["de"].toLowerCase() === itemName.toLowerCase())
    if (!item) {
...
module.exports = {
    name: 'price-german',
    description: 'GERMAN! Displays price graph of the item specified.',
    options: [
        {
            name: "item-name",
