...
const { Client, IntentsBitField, AttachmentBuilder, EmbedBuilder, Embed, GatewayIntentBits } = require('discord.js');
...
// AUTO COMPLETE
   ...
   /*    for (let i = 0; i < entry.length; i++ ){
        ...
        if(itemTyped.length >2 && !isNaN(itemTyped)){ //WEIRD WORK AROUND.... autocomplete and bot will crash if i dont stop it here. idk why tbh
